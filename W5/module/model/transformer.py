...
from tensorflow.keras.layers import Embedding, Conv1D, GlobalMaxPooling1D, Dense, Dropout, Flatten, MaxPooling1D, Input, Concatenate, Bidirectional, LSTM, Input, Activation,GRU
from tensorflow.keras.layers import MaxPooling1D, Add, Flatten, GlobalAveragePooling1D, concatenate, SpatialDropout1D
